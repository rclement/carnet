...
def _create_instance_config(instance_config_file):
...
def _register_blueprints(app):
    ...
    assets_bp = create_assets_blueprint(app.config.get('ASSETS_ROOT'))
...
def _register_freezer_generators(app):
    app_theme = app.theme_manager.themes.get(app.config.get('THEME'), None)
    spa_theme = app_theme.info.get('spa', False)
...
def create_app(
    ...
    _create_instance_config(instance_config_file)
    ...
    _register_freezer_generators(app)
